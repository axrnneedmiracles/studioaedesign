...
const floatingImages = [
  ...
  { src: '/canva/pic2.jpg', alt: 'Canva design 2', className: 'bottom-20 -right-52 w-56 h-40 rotate-[10deg]' },
  { src: '/canva/pic4.jpg', alt: 'Canva design 4', className: 'top-20 -right-44 w-40 h-56 rotate-[-5deg]' },
  { src: '/canva/pic5.jpg', alt: 'Canva design 5', className: 'bottom-10 -left-52 w-56 h-40 rotate-[8deg]' },
];
...
export function CanvaShowcase() {
  ...
  return (
    <div className="relative flex justify-center items-center w-full min-h-[60vh] my-16">
      ...
      {/* TV screen */}
      <div className="relative w-[40vw] max-w-2xl aspect-video bg-black border-[1.5vw] md:border-8 border-gray-800 rounded-2xl shadow-2xl p-1 md:p-2 flex items-center justify-center z-10">
